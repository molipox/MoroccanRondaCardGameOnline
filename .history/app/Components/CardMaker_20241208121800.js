...
const CardMaker = ({ref, CardNumber, CardType, zIndex, left, bottom, rotate, HandleClick, ChangeCards, cardsContainer, TablePosition, imageHeight, index,HandleDrag, handleRef }) => {
  ...
  useEffect(() => {
    ...
    tableMiddleY = (TablePosition.bottom - cardBottom) * 0.95;
        console.log("tabposition",TablePosition)
        console.log( "card bottom",cardBottom)
    tableMiddleX = (TablePosition.x - cardX) / 2 - (cardsContainerWidth * (left / 100));
  },[]);
  useGSAP(()=>{
